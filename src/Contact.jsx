  ...
  return (
    <div>
      ...
      <p className="text-white text-[14px] mt-3 ml-25">
        Feel free to reach out if you're interested in collaborating or have any
        questions about my work. <br />
        You can contact me via email or connect with me on LinkedIn—I'd love to
        hear from you!
      </p>
      ...
      <div>
        ...
        >
          <p className="text-center text-blue-500 ">Submit</p>
           ...
           <br />
           <br />
           <div className="w-full h-10 bg-cyan-950 text-center text-white "><p className="pt-3"> Developed with love by Naveen@2025</p></div>
    </div>
  );
};
